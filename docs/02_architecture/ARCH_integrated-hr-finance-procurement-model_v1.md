...
گاردها مبلغ مثبت، مانده بودجه، سطح تأیید، نسخه اصلاح و تطابق صورتحساب با رسید را کنترل می‌کنند. رسید جزئی وارد `PartiallyReceived` می‌شود و هر گذار مهم در `AuditLog` ثبت می‌گردد.
