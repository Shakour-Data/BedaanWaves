...
**توضیح:** این نمونه یک کارمند فعال، واحد مالی، یک درخواست خرید پیش‌نویس، سفارش ایجادشده و لات موجودی را در یک سناریوی کلی نشان می‌دهد. مقادیر، نمونه‌ای از ارتباط معنایی بین اشیاء هستند و رفتار محاسبه یا پرداخت را اجرا نمی‌کنند. این نما با مدل دامنه سطح �1 کلاس هم‌خوان است.
