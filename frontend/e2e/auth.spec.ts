...
test.describe('Authentication Flow - DISABLED', () => {
  ...
  test.skip('should navigate to leaderboard after successful login', async ({ page }) => {
    await page.goto('/login');
  ...
  test('should show disabled message on login page', async ({ page }) => {
    await page.goto('/login');
    await expect(page.locator('text=Authentication Disabled')).toBeVisible();
  });
});
