...
export default function NerkIndexPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-[var(--color-text-primary)]">Nasdaq Index</h1>
        <p className="mt-2 text-[var(--color-text-muted)]">
          Nasdaq index constituents and market overview.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        >
          ...
          <p className="mt-2 text-sm text-[var(--color-text-muted)]">
            View all Nasdaq index constituents with price history and fundamentals.
          </p>
