...
class AioHttpClient(IHttpClient):
    ...
    async def get(self, url: str, params: dict[str, Any] | None = None, headers: dict[str, Any] | None = None) -> Result[Any]:
        return await self._request("GET", url, params=params, headers=headers)

    async def post(self, url: str, data: Any = None, json: Any = None, headers: dict[str, Any] | None = None) -> Result[Any]:
