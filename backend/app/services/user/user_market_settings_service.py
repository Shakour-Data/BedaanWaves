...
class UserMarketSettingsService(BaseService):
    ...
    async def get_user_settings(self, user_id: str) -> dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"Error getting user settings for {user_id}: {e!s}")
            return self.default_settings.copy()
    ...
    async def update_user_settings(self,
        ...
        try:
            ...
            self.logger.error(f"Error updating user settings for {user_id}: {e!s}")
            raise
    ...
    async def update_country_selection(self,
        ...
        try:
            ...
            self.logger.error(f"Error updating country selection for {user_id}: {e!s}")
            raise
    ...
    async def update_index_selection(self,
        ...
        try:
            ...
            self.logger.error(f"Error updating index selection for {user_id}: {e!s}")
            raise
    ...
    async def update_industry_selection(self,
        ...
        try:
            ...
            self.logger.error(f"Error updating industry selection for {user_id}: {e!s}")
            raise
