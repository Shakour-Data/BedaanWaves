...
class BaseService(ABC):
    ...
    def cache_clear(self, key: str | None = None) -> None:
...
class CachedService(BaseService):
    ...
    def __init__(self, service_name: str, logger: logging.Logger | None = None, cache_ttl_seconds: int = 3600):
    ...
    def set_cached(self, key: str, value: Any, ttl_seconds: int | None = None) -> None:
