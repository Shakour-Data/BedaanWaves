...
class MonetaryPolicyService(AnalysisService):
    ...
    async def analyze(self, data: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            self.logger.error(f"MMT analysis failed: {e!s}")
    ...
    async def _classify_mmt_regime(
        ...
        try:
            ...
            if gov_balance > 0:
                ...
                min(abs(gov_balance) / 100, 1.0)  # Normalize
            else:
                fiscal_stance = "contractionary"  # Government surplus
                min(abs(gov_balance) / 100, 1.0)
    ...
    async def _calculate_fiscal_space(self, data: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            fiscal_space = min(
                ...
                _employed_constrained_spending := employment_constrained_spending
            )
