...
-- Insert core assets (TSE, Crypto, NASDAQ symbols)
...
(1, 'KHC1', 'کاهید', 'EQUITY', 'TSE', 'IR', 'IRT', 'Banks', 'Banking', true, NOW(), NOW(), '{}'),
(2, 'FAZF1', 'فازف', 'EQUITY', 'TSE', 'IR', 'IRT', 'Pharmaceuticals', 'Healthcare', true, NOW(), NOW(), '{}'),
(3, 'KHOD1', 'خود', 'EQUITY', 'TSE', 'IR', 'IRT', 'Automotive', 'Manufacturing', true, NOW(), NOW(), '{}'),
(4, 'SHAH1', 'شهید', 'EQUITY', 'TSE', 'IR', 'IRT', 'Construction', 'Building Materials', true, NOW(), NOW(), '{}'),
(5, 'MELL1', 'ملت', 'EQUITY', 'TSE', 'IR', 'IRT', 'Banking', 'Banking', true, NOW(), NOW(), '{}'),
-- Crypto
(6, 'BTCUSD', 'Bitcoin', 'CRYPTO', 'BINANCE', 'GLOBAL', 'USD', NULL, NULL, true, NOW(), NOW(), '{}'),
(7, 'ETHUSD', 'Ethereum', 'CRYPTO', 'BINANCE', 'GLOBAL', 'USD', NULL, NULL, true, NOW(), NOW(), '{}'),
(8, 'ADAUSD', 'Cardano', 'CRYPTO', 'BINANCE', 'GLOBAL', 'USD', NULL, NULL, true, NOW(), NOW(), '{}'),
(9, 'XRPUSD', 'XRP', 'CRYPTO', 'BINANCE', 'GLOBAL', 'USD', NULL, NULL, true, NOW(), NOW(), '{}'),
(10, 'DOGEUSD', 'Dogecoin', 'CRYPTO', 'BINANCE', 'GLOBAL', 'USD', NULL, NULL, true, NOW(), NOW(), '{}'),
-- NASDAQ
(11, 'AAPL', 'Apple Inc.', 'EQUITY', 'NASDAQ', 'US', 'USD', 'Technology', 'Consumer Electronics', true, NOW(), NOW(), '{}'),
(12, 'GOOGL', 'Google LLC', 'EQUITY', 'NASDAQ', 'US', 'USD', 'Technology', 'Internet Services', true, NOW(), NOW(), '{}'),
(13, 'MSFT', 'Microsoft Corp', 'EQUITY', 'NASDAQ', 'US', 'USD', 'Technology', 'Software', true, NOW(), NOW(), '{}'),
(14, 'TSLA', 'Tesla Inc.', 'EQUITY', 'NASDAQ', 'US', 'USD', 'Automotive', 'Electric Vehicles', true, NOW(), NOW(), '{}'),
(15, 'AMZN', 'Amazon.com Inc.', 'EQUITY', 'NASDAQ', 'US', 'USD', 'Technology', 'E-commerce', true, NOW(), NOW(), '{}');
...
BEGIN
    FOR asset_id IN SELECT id FROM assets LOOP
        ...
        WHILE current_date <= end_date LOOP
            ...
            IF (SELECT market FROM assets WHERE id = asset_id) = 'TSE' THEN
                INSERT INTO ir_price_candles (asset_id, timeframe, timestamp, open, high, low, close, volume, turnover, transactions)
                VALUES (asset_id, '1d', current_date, open_price, high_price, low_price, close_price, volume, turnover, transactions);
            ELSIF (SELECT market FROM assets WHERE id = asset_id) IN ('NASDAQ', 'NYSE') THEN
                INSERT INTO intl_price_candles (asset_id, timeframe, timestamp, open, high, low, close, volume, turnover, transactions)
                VALUES (asset_id, '1d', current_date, open_price, high_price, low_price, close_price, volume, turnover, transactions);
            ELSIF (SELECT market FROM assets WHERE id = asset_id) IN ('BINANCE', 'KRAKEN', 'COINBASE') THEN
...
(1, 1, 11, 500.0000, 150.50, NOW(), NOW()),  -- AAPL
(2, 1, 6, 2.5000, 45000.00, NOW(), NOW()),   -- BTC
(3, 2, 1, 1000.0000, 85.00, NOW(), NOW()),   -- KHC1
(4, 2, 11, 100.0000, 160.00, NOW(), NOW()); -- AAPL
    ...
    FOR asset_id IN SELECT id FROM assets LOOP
        FOR year IN 2023..2025 LOOP
            ...
            INSERT INTO financial_statements (
                asset_id, statement_type, period, quarter, report_date, data, currency, source
            ) VALUES (
                asset_id, 'balance_sheet', year || '-annual', 4, 
                date(year, 12, 31),
                jsonb_build_object(
                    'revenue', revenue,
            ...
            INSERT INTO financial_statements (
                ...
                asset_id, 'income_statement', year || '-annual', 4,
                date(year, 12, 31),
                jsonb_build_object(
                    'revenue', revenue,
            ...
            INSERT INTO financial_statements (
                ...
                asset_id, 'cash_flow_statement', year || '-annual', 4,
                date(year, 12, 31),
                jsonb_build_object(
