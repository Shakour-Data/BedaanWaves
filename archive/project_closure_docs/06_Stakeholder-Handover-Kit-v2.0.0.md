...
| 2.3 | **[ACTION-REQUIRED] Deploy: Stop Services** | (a) Drain frontend sessions (graceful stop 60-second timeout). (b) Stop backend service. (c) Enable maintenance-mode  on both: return 503 Retry-After for ALL non-admin endpoints. Users see "Platform maintenance" splash. | 06:06:00 – 06:08:00 | Infra Lead | ☐ |
